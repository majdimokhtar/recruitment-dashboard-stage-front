      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              title: 'Post A Job',
              path: '/apps/recruitment/employeer/jobs/new'
            },
            {
              title: 'Applied Jobs',
              path: '/apps/recruitment/me/applied'
            },
            {
              title: 'My Jobs',
              path: '/apps/recruitment/employeer/jobs/'
            },
          ]
        },
        {
        ...
        },
        {
          ...
          children: [
            {
              title: 'Page 1',
              path: '/apps/project-management/page1'
            },
            {
              title: 'Page 2',
              path: '/apps/project-management/page2'
            },
            {
              title: 'Page 3',
              path: '/apps/project-management/page3'
            },
          ]
        },
        {
